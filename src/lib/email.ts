...
function healthEmailShell(content: string) {
  return `<!doctype html><html lang="en"><body style="margin:0;padding:0;background:#f4f7f7;color:#17212b;font-family:Arial,Helvetica,sans-serif"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f4f7f7"><tr><td align="center" style="padding:28px 12px"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:640px;background:#ffffff;border:1px solid #dbe3e4;border-radius:16px;overflow:hidden"><tr><td style="padding:24px 32px;border-bottom:4px solid #00AD84;background:#ffffff"><div style="color:#17212b;font-family:Arial,Helvetica,sans-serif;font-size:24px;font-weight:bold;letter-spacing:-1px;line-height:28px">Upsight <span style="color:#00AD84">Digital</span></div></td></tr>${content}<tr><td style="padding:24px 32px;background:#ffffff;border-top:1px solid #dbe3e4;color:#5f6b73;font-size:13px;line-height:20px">Upsight Digital<br><a href="https://upsight.digital" style="color:#007f63;text-decoration:none">upsight.digital</a></td></tr></table></td></tr></table></body></html>`;
}
