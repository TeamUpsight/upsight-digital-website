...
export const technologyCatalog = {
  ...
  appsflyer: { key: 'appsflyer', name: 'AppsFlyer', logo: '/images/tech/appsflyer.png' },
  adjust: { key: 'adjust', name: 'Adjust', logo: '/images/tech/adjust.png' },
  branch: { key: 'branch', name: 'Branch', logo: '/images/tech/branch.svg' },
  kochava: { key: 'kochava', name: 'Kochava', logo: '/images/tech/kochava.png' },
