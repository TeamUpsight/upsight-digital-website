  ...
  return (
    <div className={`w-full ${className}`} style={{ perspective: '1200px' }} onKeyDown={(event) => {
      ...
      <div
        ...
        className="relative h-[500px] w-full transition-[height,transform] duration-700 motion-reduce:transition-none sm:h-[470px] lg:h-[480px]"
        style={{
        ...
        <article className="absolute inset-0" style={{ backfaceVisibility: 'hidden' }} inert={isFlipped} aria-hidden={isFlipped}>
          <Card className="h-full gap-0 border-primary/20 bg-gradient-to-br from-card via-card to-primary/5 py-0">
            <CardContent className="relative h-full p-6">
              ...
              <blockquote className="mt-6 text-sm leading-relaxed text-foreground/90 italic">{quote}</blockquote>
              <div data-testimonial-actions className="absolute inset-x-6 bottom-6 min-h-[7.5rem] space-y-3 border-t border-border/50 pt-4">
